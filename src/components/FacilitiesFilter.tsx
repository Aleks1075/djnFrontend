...
const FacilitiesFilter = ({onChange, selectedFacilities, isExpanded, onExpandedClick}: Props) => {
    ...
    return (
        ...
        <div className="flex justify-between items-center px-2">
          <div className="text-md font-semibold mb-2">Filtrer efter facilititer</div>
          <div onClick={handleFacilitiesReset} className="text-sm font-semibold mb-2 underline cursor-pointer text-yellow-500">
            Nulstil filter
          </div>
          </div>

          <div className="space-y-2 flex flex-col">
        {facilitiesList.slice(0, isExpanded ? facilitiesList.length : 7)
        .map((facility) => {
