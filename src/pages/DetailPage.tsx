...
const DetailPage = () => {
  ...
  const addToCart = (eventItem: EventItem) => {
    setCartItems((prevCartItems) => {
        ...
        const existingCartItem = prevCartItems.find((cartItem) => cartItem._id === eventItem._id);
        ...
        sessionStorage.setItem(`cartItems-${eventId}`, JSON.stringify(updatedCartItems));
    ...
    return (
        <div className="flex flex-col gap-10">
            ...
            <div className="grid md:grid-cols-[4fr_2fr] gap-5 md:px-32">
                ...
                <div>
                    <Card>
                        <OrderSummary event={event} cartItems={cartItems} removeFromCart={removeFromCart}/>
                        <CardFooter>
                            <CheckoutButton 
